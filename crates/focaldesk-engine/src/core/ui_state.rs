...
// crates/focaldesk-engine/src/core/ui.rs
//use focaldesk_ui::widgets::ClockCache;
use std::collections::HashMap;
use std::marker::PhantomData;
//use crate::core::chrome_sdf::{SdfBeveledPanel, SdfLightChannel};
use smithay::backend::renderer::gles::GlesRenderer;

use focaldesk_ui::{chrome::Chrome, text::TextSystem, widgets::ClockCache};
...
pub struct UiState<Tex: 'static> {
    ...
    pub text: focaldesk_ui::text::TextSystem,
    pub clock: focaldesk_ui::chrome::ClockCache,
...
impl<Tex: 'static> UiState<Tex> {
    ...
    pub fn bootstrap() -> Self {
        Self::new(
            Chrome::new(focaldesk_ui::chrome::ChromeMetrics::default()), // or Chrome::default()
