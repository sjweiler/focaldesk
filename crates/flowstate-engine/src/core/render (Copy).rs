...
pub fn draw_rounded_rect(
   ...
   // 1) CHANGE render_into_frame()
    ...
    pub fn render_into_frame(
        ...
        self.draw_wallpaper_in_rect(frame, inputs.ctx, layout_phys.work_recess);
...
*/
  ...
  pub fn draw_active_lightbar(
    ...
    fn draw_chrome_below_work_wallpaper(
        ...
        let theme: ChromeTheme = default_chrome_theme();
            ...
            .enumerate()
        {
            ...
            let _ = Self::draw_beveled_panel(frame, beveled, *outer, damage, &theme.module);
            let _ = Self::draw_beveled_panel(frame, beveled, *inner, damage, &theme.module_inner);
            Self::draw_recessed_button(frame, button, *well, damage, &theme.button);
            ...
            let mut light_style = theme.light;
            ...
            let _ = Self::draw_light_channel(frame, light, glow_rect, damage, &light_style);
                ...
                //let glow_rect = inset_rect(*well, 3);
                //let _ = Self::draw_light_channel(frame, light, glow_rect, damage, &theme.light);
           // }
        }
        ...
        for rect in &layout.sidebar_caps {
            Self::draw_beveled_panel(frame, beveled, *rect, damage, &theme.corner_cap);
        }
