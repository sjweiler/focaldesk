...
impl Keybinds {
    ...
    fn common_keybindings(&mut self) {
            ...
            self.map.insert(
                KeyCombo { mods: ModMask::SUPER, sym: keysyms::KEY_F8 },
                KeyAction::FocusNext,
            );

            self.map.insert(
                KeyCombo { mods: ModMask::SUPER, sym: keysyms::KEY_F7 },
                KeyAction::FocusPrev,
            );

            self.map.insert(
                KeyCombo { mods: ModMask::CTRL | ModMask::ALT, sym: keysyms::KEY_d},
        ...
        fn drm_keybindings(&mut self) {
            ...
            self.map.insert(
                KeyCombo { mods: ModMask::empty(), sym: keysyms::KEY_Escape },
                KeyAction::ForceExit,
            );

            self.map.insert(
                KeyCombo { mods: ModMask::empty(), sym: keysyms::KEY_Print },
                KeyAction::TakeScreenshot,
            );
            
            self.map.insert(
                KeyCombo { mods: ModMask::SHIFT, sym: keysyms::KEY_Print },
