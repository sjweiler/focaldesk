...
pub fn moonbase_theme() -> FlowTheme {
    FlowTheme {
        ...
        text: TextTheme {
            title: [0.96, 0.99, 1.00, 1.0],
            normal: [0.90, 0.95, 1.00, 1.0],
            dim: [0.68, 0.76, 0.82, 1.0],
            accent: [0.58, 0.86, 1.00, 1.0],
            meta_label: [0.84, 0.91, 0.96, 1.0],
            meta_value: [1.00, 0.86, 0.42, 1.0],
            clock: [0.96, 0.99, 1.00, 1.0],
        },

        icons: IconTheme {
            inactive: [0.90, 0.96, 1.00, 1.00],
            hover: [1.00, 1.00, 1.00, 1.00],
            active: [0.62, 0.90, 1.00, 1.00],
            disabled: [0.46, 0.52, 0.56, 0.62],
...
pub fn classic_theme() -> FlowTheme {
    FlowTheme {
        ...
        text: TextTheme {
            ...
            clock: [1.00, 0.88, 0.48, 1.0],
        },

        icons: IconTheme {
            inactive: [1.00, 0.68, 0.30, 1.0],
            hover: [1.0, 0.82, 0.38, 1.0],
            active: [1.0, 0.82, 0.38, 1.0],
